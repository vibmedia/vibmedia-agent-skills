...
| "This is too simple to need a design" | Simple projects = unexamined assumptions |

---

## Hard Gate (from Superpowers)
...
6. **Transition to implementation** — invoke plan-writing skill
